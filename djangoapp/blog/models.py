...
class PostAttachment(AbstractAttachment):
        def save(self, *args, **kwargs):
            ...
            print('current image name', current_file_name)
...
class Post(models.Model):
    ...
    cover_in_post_content = models.BooleanField(
        default=True,
        help_text='exibe a imagem de capa tambem dentro do conteudo do post'
    )
    ...
    def save(self, *args, **kwargs):
        ...
        print('current cover name', current_cover_name)
        super_save = super().save(*args, **kwargs)
        cover_changed = False
        if self.cover:
            _changed = current_cover_name != self.cover.name
        if cover_changed:
